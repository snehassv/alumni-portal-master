        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home.php"><i class="fa fa-desktop"></i> News Letters</a>
                    </li>
					<!--<li>
                        <a href="home.php"><i class="fa fa-bar-chart-o"></i>Room Booking</a>
                    </li>
                    <li>
                        <a href="home.php"><i class="fa fa-qrcode"></i> Payment</a>
                    </li>
                    <li>
                        <a  href="home.php"><i class="fa fa-qrcode"></i> Profit</a>
                    </li>-->
                    <li>
